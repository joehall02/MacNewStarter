...
export MEDIA_BOOKS_PATH="${MEDIA_BOOKS_PATH_ENV}"
...
# Shelfmark
export SHELFMARK_PUID="${SHELFMARK_PUID_ENV}"
export SHELFMARK_PGID="${SHELFMARK_PGID_ENV}"
export SHELFMARK_PORT="${SHELFMARK_PORT_ENV}"
export SHELFMARK_CONFIG_PATH="${SHELFMARK_CONFIG_PATH_ENV}"
